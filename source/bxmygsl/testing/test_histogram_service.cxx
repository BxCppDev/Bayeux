...
int main (int argc_, char ** argv_)
{
  ...
  try
    {
      clog << "Test program for class 'mygsl::histogram_service' !" << endl;
...

      {
        ...
        string services_setup_file = "${MYGSL_DATA_DIR}/testing/config/test_service_manager.conf";
        ...
        if (SM.has ("Histos") && SM.is_a<mygsl::histogram_service> ("Histos"))
          {
            ...
            if (export_root) Histos.store_as_root_file("${MYGSL_TMP_TEST_DIR}/test_histogram_service.root");
