...
struct quadratic : public mygsl::i_unary_function
{
  quadratic ()
  {
    a =  1.0;
...
int main (int argc_, char ** argv_)
{
  try {
    ...
    clog << "  root = " << mygsl::one_dimensional_root_solver::solve (q, epsabs, 0.0, 5.0, method_name) << endl;
