...
function do_mygsl_setup ()
{
    ...
    export MYGSL_BIN_DIR="@CMAKE_INSTALL_PREFIX@/bin"
    export MYGSL_ETC_DIR="@CMAKE_INSTALL_PREFIX@/etc"
    export MYGSL_LIB_DIR="@CMAKE_INSTALL_PREFIX@/lib"
	...
	if [ -n "${CMAKE_MODULE_PATH}" ]; then 
            export CMAKE_MODULE_PATH="@CMAKE_INSTALL_PREFIX@/@MYGSL_CMAKE_MODULE_INSTALL_DIR@:${CMAKE_MODULE_PATH}"
	else
            export CMAKE_MODULE_PATH="@CMAKE_INSTALL_PREFIX@/@MYGSL_CMAKE_MODULE_INSTALL_DIR@"
	fi
    fi
