==============================================================
Validation of the tracking of arbitrarily charged ions in a
constant electric field in the Bayeux/mctools Geant4 module.
==============================================================
...
of motion of such ions in an electric field produces acceptable results.
 ...
 * ``mctools_g4_ex02_C12_ion_traj.pdf`` : The figure that superimposes
   the predicted trajectories with result from the Geant tracking.

The simulation have been done using the ``bxg4_production`` program, here
with the ``C12_ion_1plus_monokinetic_1keV`` event generator: ::
...
See the ``README.rst`` file in the base directory of example ``ex02`` for details.
