...
void test_signal_data_2(bool draw_ = false);
...
void test_signal_data_2(bool draw_)
{

  datatools::things event_record;

  mctools::signal::signal_data & signals = event_record.add<mctools::signal::signal_data>("SSD");
  signals.grab_auxiliaries().store("Generator", "flsiggen");
  signals.grab_auxiliaries().store("Author", "Bevedere");
  signals.grab_auxiliaries().store("Date", "2016-09-27");
...

  {
    ...
    datatools::data_writer writer("test_signal_signal_data.xml");
...

  {
    ...
    datatools::data_reader reader("test_signal_signal_data.xml");
    reader.load(er);
    er.tree_dump(std::clog, "Loaded event record:");
  }
