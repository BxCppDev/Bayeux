...
namespace mctools {
  ...
  namespace g4 {
                                             ...
                                             const string & a_title)
    {
      ...
      a_out << "         --config ${MCTOOLS_G4_DATA_DIR}/testing/config/g4/test-1.0/manager.conf \\" << endl;
      a_out << "                  ${MCTOOLS_G4_DATA_DIR}/testing/config/g4/test-1.0/g4vis.mac" << endl;
      a_out << endl;
                                    ...
                                    manager & a_manager)
    {
      ...
      datatools::multi_properties
        the_configuration ("name",
                           "",
                           "Configuration for the 'sng4' simulation manager");
