  ...
  try
    {
      ...
      geomtools::vector_3d D = -0.2 * ( A -B ) + 0.5 * (C - B);
      int nshoots = 10000;
      for (int i = 0; i < nshoots; i++)
        {
          ...
          geomtools::vector_3d vertex
            = genvtx::quadrangle_random_surface (A, B, C, D, random, 
                                                 sABC, sCDA);
      ...
      geomtools::basic_polyline_3d ABCDA;
      ABCDA.push_back(A);
      ABCDA.push_back(B);
      ABCDA.push_back(C);
      ABCDA.push_back(D);
      ABCDA.push_back(A);
      geomtools::gnuplot_draw::basic_draw_polyline (tmp_file.out (),ABCDA);
      tmp_file.out () << endl << endl;
      ...
      if (draw)
        {         
          ...
          { 
            g1.cmd ("set grid");
            g1.cmd ("set title 'test quadrangle_random_tools'");
...
// end of test_quadrangle_random_tools.cxx
