...
namespace genvtx {
  ...
  {
    _assert_lock ("genvtx::cylinder_model_vg::set_surface_side");
    _surface_side_ = s_;
    return;
  }
  ...
  {
    _assert_lock ("genvtx::cylinder_model_vg::set_surface_top");
    _surface_top_ = s_;
    return;
  }
  ...
  {
    _assert_lock ("genvtx::cylinder_model_vg::set_surface_bottom");
    _surface_bottom_ = s_;
    return;
  }
  ...
  {
    _assert_lock ("genvtx::cylinder_model_vg::set_origin_rules");
  ...
  void cylinder_model_vg::set_mapping_plugin_name(const std::string & mpn_)
  {
    if (is_initialized())
      {
        throw std::logic_error ("genvtx::cylinder_model_vg::set_mapping_plugin_name: Already initialized !");
      }
  ...
  void cylinder_model_vg::set_materials_plugin_name(const std::string & mpn_)
  {
    if (is_initialized())
      {
        throw std::logic_error ("genvtx::cylinder_model_vg::set_materials_plugin_name: Already initialized !");
      }
  ...
  {
    _assert_lock ("genvtx::cylinder_model_vg::set_mode");
  ...
  GENVTX_VG_RESET_IMPLEMENT_HEAD(cylinder_model_vg)
  {
    if (! is_initialized ())
      {
        throw std::logic_error ("genvtx::cylinder_model_vg: Not initialized !");
      }
    _reset_ ();
    _initialized_ = false;
    return;
    ...
    if (! _initialized_)
      {
        ...
        message << "genvtx::cylinder_model_vg::_shoot_vertex: "
                                                   ...
                                                   geomtools::vector_3d & vertex_)
  {
    ...
    if (index < 0)
      {
        std::ostringstream message;
        message << "genvtx::cylinder_model_vg::_shoot_vertex_cylinders: "
  ...
  {      
    if (! is_mode_valid ())
      {
        std::ostringstream message;
        message << "genvtx::cylinder_model_vg::initialize: "
                << "Invalid mode !";
        throw std::logic_error (message.str ());
      }
    ...
    if (src_shape.get_shape_name () != "cylinder")
      {
        std::ostringstream message;
        message << "genvtx::cylinder_model_vg::initialize: "
  ...
  {
    if (is_debug ()) std::cerr << "DEBUG: genvtx::cylinder_model_vg::initialize: Entering..." << std::endl;
    using namespace std;
    bool devel = false;
    if (is_initialized ())
      {
        throw std::logic_error ("genvtx::cylinder_model_vg::initialize: Already initialized !");
      }
    ...
    if (setup_.has_key ("origin"))
      ...
      {
        std::ostringstream message;
        message << "genvtx::cylinder_model_vg::create: "
