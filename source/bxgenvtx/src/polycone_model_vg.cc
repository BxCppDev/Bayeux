...
namespace genvtx {
  ...
  const std::string & polycone_model_vg::get_origin_rules() const
  {
    return _origin_rules_;
  }

  void polycone_model_vg::set_origin_rules(const std::string & origin_rules_)
  {
    DT_THROW_IF(is_initialized(), std::logic_error, "Vertex generator '" << get_name() << "' is already initialized !");
  ...
  bool polycone_model_vg::has_mapping_plugin_name() const
  {
    return ! _mapping_plugin_name_.empty();
  }

  const std::string & polycone_model_vg::get_mapping_plugin_name() const
  {
    return _mapping_plugin_name_;
  }

  void polycone_model_vg::set_mapping_plugin_name(const std::string & mpn_)
  {
    DT_THROW_IF(is_initialized(), std::logic_error, "Vertex generator '" << get_name() << "' is already initialized !");
  ...
  bool polycone_model_vg::has_materials_plugin_name() const
  {
    return ! _materials_plugin_name_.empty();
  }

  const std::string & polycone_model_vg::get_materials_plugin_name() const
  {
    return _materials_plugin_name_;
  }

  void polycone_model_vg::set_materials_plugin_name(const std::string & mpn_)
  {
    DT_THROW_IF(is_initialized(), std::logic_error, "Vertex generator '" << get_name() << "' is already initialized !");
  ...
  polycone_model_vg::polycone_model_vg() : genvtx::i_vertex_generator()
  {
    _initialized_ = false;
    _set_defaults_();
    return;
