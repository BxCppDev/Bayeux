# - cmake file for ROOT dictionnary generation from the brio/src subdir
...
message ( STATUS "NOTICE: _brio_dict_sources='${_brio_dict_sources}'" )
...
if ( _generate_root_dict )
    ADD_CUSTOM_COMMAND(OUTPUT ${_brio_dict_sources}
       COMMAND SOURCE_PATH=${PROJECT_SOURCE_DIR}
               ...
               ${PROJECT_SOURCE_DIR}/cmake/make_dict.sh --rootcint ${ROOT_CINT_EXECUTABLE}
