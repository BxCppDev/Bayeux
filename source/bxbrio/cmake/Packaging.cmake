...
set(CPACK_COMPONENT_BIN_DISPLAY_NAME "brio library")
set(CPACK_COMPONENT_BIN_DESCRIPTION "The brio library binaries")
set(CPACK_COMPONENT_BIN_INSTALL_TYPES Runtime Development)

set(CPACK_COMPONENT_DEVEL_DISPLAY_NAME "brio development files")
...
set(CPACK_COMPONENT_APIDOC_DISPLAY_NAME "brio API documentation")
...
set(CPACK_COMPONENT_UTILS_DISPLAY_NAME "brio utilities")
set(CPACK_COMPONENT_UTILS_DESCRIPTION
    "Provides a FindBrio.cmake file to be used with project based on CMake"
)
set(CPACK_COMPONENT_UTILS_GROUP "Development")
set(CPACK_COMPONENT_UTILS_DISABLED TRUE)

set(CPACK_COMPONENT_GROUP_DEVELOPMENT_DESCRIPTION "Components related to software development based on brio")
set(CPACK_COMPONENT_GROUP_DEVELOPMENT_EXPANDED TRUE)

# Package setup
set(CPACK_PACKAGE_NAME brio)
set(CPACK_PACKAGE_VENDOR "François Mauger, LPC Caen - University of Caen Basse-Normandie")
set(CPACK_PACKAGE_VERSION_MAJOR ${VERSION_MAJOR})
set(CPACK_PACKAGE_VERSION_MINOR ${VERSION_MINOR})
set(CPACK_PACKAGE_VERSION_PATCH ${VERSION_PATCH})
set(CPACK_PACKAGE_DESCRIPTION_FILE ${BRIO_SOURCE_DIR}/README.txt)
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "brio is a multi-purpose C++ library")
set(CPACK_PACKAGE_INSTALL_DIRECTORY ${CPACK_PACKAGE_VENDOR}\\\\brio)
set(CPACK_RESOURCE_FILE_LICENSE ${BRIO_SOURCE_DIR}/COPYING.txt)
set(CPACK_RESOURCE_FILE_README ${BRIO_SOURCE_DIR}/README.txt)
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY brio)
...
# NSIS setup
#set(CPACK_NSIS_MUI_ICON ${BRIO_SOURCE_DIR}/doc/images\\\\logo.ico)
#set(CPACK_NSIS_MUI_UNIICON ${BRIO_SOURCE_DIR}/doc/images\\\\logo.ico)
#set(CPACK_PACKAGE_ICON ${BRIO_SOURCE_DIR}/doc/images\\\\logo_package.bmp)
#set(CPACK_NSIS_EXTRA_INSTALL_COMMANDS)
#set(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS)
#set(CPACK_NSIS_COMPRESSOR)
#set(CPACK_NSIS_MODIFY_PATH)
set(CPACK_NSIS_DISPLAY_NAME brio)
