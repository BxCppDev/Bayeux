...
int main (int argc_, char ** argv_)
{
  ...
  try
      ...
      while (iarg < argc_)
	{
      ...
      mgr.set ("${GENBB_HELP_RESOURCES_DIR}/testing/data/bipo212_1.boost.txt.gz");
      mgr.set ("${GENBB_HELP_RESOURCES_DIR}/testing/data/bipo212_2.boost.txt.gz");
      mgr.set ("${GENBB_HELP_RESOURCES_DIR}/testing/data/bipo212_3.boost.txt.gz");
      if (debug) mgr.dump ();
