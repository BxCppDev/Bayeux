...
int main (int argc_, char ** argv_)
{
  ...
  try
      ...
      while (iarg < argc_)
	{
      ...
      mgr.set ("${GENBB_HELP_RESOURCES_DIR}/testing/data/bipo212_1.genbb");
      mgr.set ("${GENBB_HELP_RESOURCES_DIR}/testing/data/bipo212_2.genbb");
      mgr.set ("${GENBB_HELP_RESOURCES_DIR}/testing/data/bipo212_3.genbb");
      if (debug) mgr.dump ();
