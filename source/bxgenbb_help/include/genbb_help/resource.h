...
//!        environment variable GENBB_HELP_DATA_DIR as a directory path on the filesystem
...
//! the GENBB_HELP_DATA_DIR environment variable to a path holding custom
//! resources.
//! \param rname name of resource, given as a path relative to
//!        resource root.
//! \param overriden_env flag to allow path overriding by the GENBB_HELP_DATA_DIR environment variable.
