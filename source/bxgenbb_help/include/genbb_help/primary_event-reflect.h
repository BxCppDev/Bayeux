// -*- mode: c++; -*-
//! \file primary_event-reflect.h
#ifndef GENBB_HELP_PRIMARY_EVENT_REFLECT_H_
#define GENBB_HELP_PRIMARY_EVENT_REFLECT_H_
...
#endif // GENBB_HELP_PRIMARY_EVENT_REFLECT_H_
