#ifndef GENBB_DECAY0_GAMMA_H_
#define GENBB_DECAY0_GAMMA_H_ 1
...
namespace genbb {
  ...
  namespace decay0 {
    ...
    /// \brief Generation of emission of gamma quantum with fixed energy isotropically in the whole space.
