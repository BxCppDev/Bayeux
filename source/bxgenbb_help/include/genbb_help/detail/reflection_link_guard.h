 ...
 *
 */
#ifndef GENBB_HELP_DETAIL_REFLECTION_LINK_GUARD_H_
#define GENBB_HELP_DETAIL_REFLECTION_LINK_GUARD_H_
 ...
 *        against the genbb_help_reflection DLL with new gcc 4.6 linking strategy
 *        even if no explicit genbb_help reflection code is explicitely
