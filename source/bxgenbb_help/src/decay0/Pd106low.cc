...
namespace genbb {
  namespace decay0 {
    ...
    void Pd106low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      ...
      // Call : call Pd106low(levelkev)
      // Input : levelkev - energy of Pd106 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV,
      // 2+(1) - 512 keV,
      // 2+(2) - 1128 keV,
      ...
      tclev=0.;
      // if (levelkev == 2741) goto label_2741
      if (levelkev == 1706) goto label_1706;
      if (levelkev == 1562) goto label_1562;
      if (levelkev == 1134) goto label_1134;
      if (levelkev == 1128) goto label_1128;
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Pd106: wrong level [keV] ',levelkev
      return;
    }
    // end of Pd106low.f
