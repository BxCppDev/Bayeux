...
namespace genbb {
  namespace decay0 {
    ...
    void Sm150low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      double t;
      double tdlev;
      double p;
      ...
      // Call : call Sm150low(levelkev)
      // Input : levelkev - energy of Sm150 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV,
      // 2+(1) - 334 keV,
      // 0+(1) - 740 keV,
      ...
      tclev=0.;
      if (levelkev == 1256) goto label_1256;
      if (levelkev == 1194) goto label_1194;
      if (levelkev == 1046) goto label_1046;
      if (levelkev ==  740) goto label_740;
      if (levelkev ==  334) goto label_334;
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Sm150: wrong level [keV] ',levelkev
      return;
    }
    // end of Sm150low.f
