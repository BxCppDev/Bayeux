...
namespace genbb {
  namespace decay0 {
    ...
    void Mo96low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      ...
      // NDS 109(2008)2501.
      // Call : call Mo96low(levelkev)
      // Input : levelkev - energy of Mo96 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV,
      // 2+(1) - 778 keV,
      // 0+(1) - 1148 keV,
      ...
      tclev=0.;
      if (levelkev == 2713) goto label_2713;
      if (levelkev == 2700) goto label_2700;
      if (levelkev == 2623) goto label_2623;
      if (levelkev == 2426) goto label_2426;
      if (levelkev == 2096) goto label_2096;
      if (levelkev == 1626) goto label_1626;
      if (levelkev == 1498) goto label_1498;
      if (levelkev == 1148) goto label_1148;
      if (levelkev ==  778) goto label_778;
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Mo96: wrong level [keV] ',levelkev
      return;
    }
    // end of Mo96low.f
