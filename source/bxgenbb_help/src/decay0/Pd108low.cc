...
namespace genbb {
  namespace decay0 {
                  ...
                  int levelkev)
    {
      ...
      // Call : call Pd108low(levelkev)
      // Input : levelkev - energy of Pd108 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV.
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Pd108: wrong level [keV] ',levelkev
      return;
    }
    // end of Pd108low.f
