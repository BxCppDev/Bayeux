...
namespace genbb {
  namespace decay0 {
   ...
   /*****************************************************/
    ...
    void denrange::reset()
    {
      datatools::invalidate(dens);
      datatools::invalidate(denf);
      mode = -1;
      return;
    }
    ...
    void helpbb::reset()
    {
      datatools::invalidate(Zd);
      datatools::invalidate(Ad);
    ...
    void eta_nme::reset()
    {
      datatools::invalidate(chi_GTw);
      datatools::invalidate(chi_Fw);
      datatools::invalidate(chip_GT);
      datatools::invalidate(chip_F);
      datatools::invalidate(chip_T);
      datatools::invalidate(chip_P);
      datatools::invalidate(chip_R);
      return;
    }
...
c             line 3 - 7 NMEs: chi_GTw, chi_Fw, chi'_GT, chi'_F, chi'_T, chi'_P, chi'_R
    ...
    */
    ...
    void bbpars::reset()
    {
      ...
      this->eta_nme::reset();
      modebb = MODEBB_UNDEF;
      datatools::invalidate(Qbb);
      datatools::invalidate(Edlevel);
      datatools::invalidate(EK);
    ...
    void decay0_bb(mygsl::rng & prng, primary_event & event, void *params)
    {
      ...
      static const double emass2 = gsl_pow_2(emass);
      ...
      if (modebb == MODEBB_9) {
        ...
        decay0_particle(prng,event,POSITRON,e0,e0,0.,pi,0.,twopi,0.,0.,t);
      ...
      if (modebb == MODEBB_11) {
        ...
        decay0_particle(prng,event,GAMMA,e0,e0,0.,pi,0.,twopi,0.,0.,t);
        decay0_particle(prng,event,GAMMA,EK,EK,0.,pi,0.,twopi,0.,0.,t);
        decay0_particle(prng,event,GAMMA,EK,EK,0.,pi,0.,twopi,0.,0.,t);
        return;
      }
      ...
      if (istartbb == 0) {
        ...
        for (int i = 1; i <= imax; i++) {
          ...
          spthe1[i-1] = 0.;
          if (modebb == MODEBB_1) {
            spthe1[i-1] = decay0_fe1_mod1(e1h,params);
          }
          if (modebb == MODEBB_2) {
            spthe1[i-1] = decay0_fe1_mod2(e1h,params);
          }
          if (modebb == MODEBB_3) {
            spthe1[i-1] = decay0_fe1_mod3(e1h,params);
          }
          ...
          if (modebb == MODEBB_7) {
            spthe1[i-1] = decay0_fe1_mod7(e1h,params);
          }
          if (modebb == MODEBB_8 && e1 < e0) {
            spthe1[i-1] = decay0_gauss(decay0_fe12_mod8,elow,ehigh,relerr,params);
          }
          if (modebb == MODEBB_10) {
            spthe1[i-1] = decay0_fe1_mod10(e1h,params);
          }
          if (modebb == MODEBB_13 && e1 < e0) {
            spthe1[i-1] = decay0_gauss(decay0_fe12_mod13,elow,ehigh,relerr,params);
          }
          if (modebb == MODEBB_14 && e1 < e0) {
            spthe1[i-1] = decay0_gauss(decay0_fe12_mod14,elow,ehigh,relerr,params);
          }
          if (modebb == MODEBB_15 && e1 < e0) {
            spthe1[i-1] = decay0_gauss(decay0_fe12_mod15,elow,ehigh,relerr,params);
          }
          if (modebb == MODEBB_16 && e1 < e0) {
            spthe1[i-1] = decay0_gauss(decay0_fe12_mod16,elow,ehigh,relerr,params);
          }
          if (modebb == MODEBB_17) {
            spthe1[i-1] = decay0_fe1_mod17(e1h,params);
          }
          if (modebb == MODEBB_18) {
            spthe1[i-1] = decay0_fe1_mod18(e1h,params);
          }
          if (spthe1[i-1] > spmax) {
            spmax = spthe1[i-1];
          }
        ...
        */
        ...
        if (modebb == MODEBB_4 || modebb == MODEBB_5 || modebb == MODEBB_6 ||
          ...
          denf = e0;
          double d_el[2];
          double r1 = decay0_dgmlt1(decay0_dshelp1,0.,denf,8,8,d_el,params);
          dens = ebb1;
          denf = ebb2;
          double r2 = decay0_dgmlt1(decay0_dshelp1,0.,denf,8,8,d_el,params);
          toallevents = r1 / r2;
        }
        else if (modebb == MODEBB_10) {
          toallevents = decay0_gauss(decay0_fe1_mod10,1.e-4,e0+1.e-4,relerr,params)
      ...
      do {
        ...
        if (modebb == MODEBB_10) {
          e1 = ebb1 + (ebb2 - ebb1) * prng();
        }
        k = (int) (e1 * 1000.);
        if (k < 1) {
          k = 1;
        }
      } while (spmax * prng() > spthe1[k - 1]);
      ...
      if (modebb == MODEBB_1 || modebb == MODEBB_2 || modebb == MODEBB_3 ||
        ...
        for (int ke2 = ke2s; ke2 <= ke2f; ke2++) {
          e2 = ke2 / 1000.;
          if (modebb == MODEBB_4)  spthe2[ke2-1] = decay0_fe2_mod4(e2,params);
          if (modebb == MODEBB_5)  spthe2[ke2-1] = decay0_fe2_mod5(e2,params);
          if (modebb == MODEBB_6)  spthe2[ke2-1] = decay0_fe2_mod6(e2,params);
          if (modebb == MODEBB_8)  spthe2[ke2-1] = decay0_fe2_mod8(e2,params);
          if (modebb == MODEBB_13) spthe2[ke2-1] = decay0_fe2_mod13(e2,params);
          if (modebb == MODEBB_14) spthe2[ke2-1] = decay0_fe2_mod14(e2,params);
          if (modebb == MODEBB_15) spthe2[ke2-1] = decay0_fe2_mod15(e2,params);
          if (modebb == MODEBB_16) spthe2[ke2-1] = decay0_fe2_mod16(e2,params);
        ...
        do {
          ...
          if (modebb == MODEBB_5)  fe2 = decay0_fe2_mod5(e2,params);
          if (modebb == MODEBB_6)  fe2 = decay0_fe2_mod6(e2,params);
          if (modebb == MODEBB_8)  fe2 = decay0_fe2_mod8(e2,params);
          if (modebb == MODEBB_13) fe2 = decay0_fe2_mod13(e2,params);
          if (modebb == MODEBB_14) fe2 = decay0_fe2_mod14(e2,params);
        ...
        decay0_particle(prng,event,POSITRON,e1,e1,0.,pi,0.,twopi,0.,0.,t);
        decay0_particle(prng,event,GAMMA,EK,EK,0.,pi,0.,twopi,0.,0.,t);
        return;
      }
      ...
      while (romaxt * prng() > a + b * ctet + c * gsl_pow_2(ctet));
      ...
      if (Zdbb >= 0.) part.set_type(ELECTRON);
      if (Zdbb < 0.) part.set_type(POSITRON);

      // First electron/positron :
      momentum.set(p1 * stet1 * std::cos(phi1),
      ...
      momentum.set(p2 * stet2 * std::cos(phi2),
