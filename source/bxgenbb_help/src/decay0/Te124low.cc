...
namespace genbb {
  namespace decay0 {
    ...
    void Te124low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      double t;
      double tdlev;
      double p;
      ...
      // Call : call Te124low(levelkev)
      // Input : levelkev - energy of Te124 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV,
      // 2+(1) - 603 keV,
      // 2+(2) - 1326 keV,
      ...
      // VIT, 23.12.2008.
      tclev=0.;
      if (levelkev == 2182) goto label_2182;
      if (levelkev == 2153) goto label_2153;
      if (levelkev == 2092) goto label_2092;
      if (levelkev == 2039) goto label_2039;
      if (levelkev == 1883) goto label_1883;
      if (levelkev == 1657) goto label_1657;
      if (levelkev == 1326) goto label_1326;
      if (levelkev ==  603) goto label_603;
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Te124: wrong level [keV] ',levelkev
      return;
    }
    // end of Te124low.f
