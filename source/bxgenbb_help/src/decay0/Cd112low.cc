...
namespace genbb {
  namespace decay0 {
    ...
    void Cd112low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      double t;
      double tdlev;
      double p;
      ...
      // Call : call Cd112low(levelkev)
      // Input : levelkev - energy of Cd112 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV,
      // 2+(1) - 618 keV,
      // 0+(1) - 1224 keV,
      ...
      // VIT, 23.12.2008.
      tclev=0.;
      if (levelkev == 1871) goto label_1871;
      if (levelkev == 1469) goto label_1469;
      if (levelkev == 1433) goto label_1433;
      if (levelkev == 1312) goto label_1312;
      if (levelkev == 1224) goto label_1224;
      if (levelkev ==  618) goto label_618;
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Cd112: wrong level [keV] ',levelkev
      return;
    }
    // end of Cd112low.f
