...
namespace genbb {
  namespace decay0 {
    ...
    void Gd156low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      //double t;
      double tdlev;
      double p;
      ...
      // Call : call Gd156low(levelkev)
      // Input : levelkev - energy of Gd156 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV,
      // 2+(1) - 89 keV,
      // 0+(1) - 1050 keV,
      ...
      // VIT, 23.12.2010.
      tclev=0.;
      if (levelkev == 2004) goto label_2004;
      if (levelkev == 1989) goto label_1989;
      if (levelkev == 1952) goto label_1952;
      if (levelkev == 1946) goto label_1946;
      if (levelkev == 1915) goto label_1915;
      if (levelkev == 1851) goto label_1851;
      if (levelkev == 1828) goto label_1828;
      if (levelkev == 1771) goto label_1771;
      if (levelkev == 1715) goto label_1715;
      if (levelkev == 1258) goto label_1258;
      if (levelkev == 1168) goto label_1168;
      if (levelkev == 1154) goto label_1154;
      if (levelkev == 1129) goto label_1129;
      if (levelkev == 1050) goto label_1050;
      if (levelkev ==  89) goto label_89;
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Gd156: wrong level [keV] ',levelkev
      return;
    }
    // end of Gd156low.f
