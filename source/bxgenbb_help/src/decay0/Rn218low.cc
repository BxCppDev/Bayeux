...
namespace genbb {
  namespace decay0 {
    ...
    void Rn218low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      //double t;
      //double tdlev;
      double tclev;
      ...
      // of Rn218.
      // Call : call Rn218low(levelkev)
      // Input : levelkev - energy of Rn218 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV.
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Rn218: wrong level [keV] ',levelkev
      return;
    }
    // end of Rn218low.f
