...
namespace genbb {
  namespace decay0 {
                  ...
                  int levelkev)
    {
      ...
      // Call : call Ba138low(levelkev)
      // Input : levelkev - energy of Ba138 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV.
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Ba138: wrong level [keV] ',levelkev
      return;
    }
    // end of Ba138low.f
