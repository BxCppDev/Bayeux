...
namespace genbb {
  namespace decay0 {
    ...
    void Po214low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      double t;
      double tdlev;
      double tclev;
      ...
      // of Po214.
      // Call : call Po214low(levelkev)
      // Input : levelkev - energy of Po214 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV.
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Po214: wrong level [keV] ',levelkev
      return;
    }
    // end of Po214low.f
