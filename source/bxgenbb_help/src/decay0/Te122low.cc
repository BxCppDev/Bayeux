...
namespace genbb {
  namespace decay0 {
    ...
    void Te122low(mygsl::rng & prng_, genbb::primary_event & event_, int levelkev)
    {
      double t;
      double tdlev;
      double tclev;
      ...
      // of Te122.
      // Call : call Te122low(levelkev)
      // Input : levelkev - energy of Te122 level (integer in keV) occupied
      // initially
      // 0+(gs) - 0 keV.
    ...
    label_10000  :
      return;
    label_20000  :
      // print *,'Te122: wrong level [keV] ',levelkev
      return;
    }
    // end of Te122low.f
