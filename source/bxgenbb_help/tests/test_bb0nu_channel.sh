...
if [ ! -f ${tmp_dir}/se82_0nubb_mn.genbb ]; then
    genbb ${GENBB_HELP_ROOT}/resources/se82_0nubb_mn.conf ${RANDOM} 3000 ${tmp_dir}/se82_0nubb_mn.genbb
fi
if [ ! -f ${tmp_dir}/se82_2nubb.genbb ]; then
    genbb ${GENBB_HELP_ROOT}/resources/se82_2nubb.conf ${RANDOM} 20000 ${tmp_dir}/se82_2nubb.genbb
fi
