  ...
  try 
    {
      ...
      std::cerr << "Hello, this is a sample program for class 'properties'!" 
		<< std::endl; 
	...
	{
	  std::cerr << "1 - du::properties::data::set_value: " 
	...
	{
	  std::cerr << "2 - du::properties::data::set_value: " 
		    << du::properties::data::get_error_message (error) 
		    << "!" << std::endl;
	}
      my_data.unlock ();
      ...
      if (int error = my_data.set_value (666, 2)) 
	{
	  std::cerr << "3 - du::properties::data::set_value: " 
		    << du::properties::data::get_error_message (error)
		    << "!" << std::endl;
	}
      my_data.dump (std::cerr);
	...
	{
	  std::cerr << "4 - du::properties::data::set_value: " 
		    << du::properties::data::get_error_message (error) 
		    << "!" << std::endl;
	}
      my_data.dump (std::cerr);
	...
	{
	  std::cerr << "5 - du::properties::data::set_value: " 
		    << du::properties::data::get_error_message (error) 
		    << "!" << std::endl;
	}
      my_data.dump (std::cerr);
      ...
      for (int i = 0; i < 12; i++) 
	{
      ...
      my_dict.dump (std::cerr);
      if (debug) my_dict.tree_dump (std::cerr, "du::properties", "DEBUG: ");
      std::cerr << std::endl;
