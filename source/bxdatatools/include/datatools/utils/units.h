...
namespace datatools {
  ...
  namespace utils {
    ...
    protected:
      ...
      static void _throw_bad_unit (const std::string & a_type, 
    ...
    public:
     ...
     /**
       ...
       *   \endcode
       */
      static double get_unit_from (const std::string & a_unit_type, 
                                   const std::string & a_unit_str);
       ...
       *
       */
      static bool find_unit (const std::string & a_unit_str, double & a_unit_value, std::string & a_unit_label);
       ...
       *   \endcode
       */
      static double get_value_with_unit (const std::string & a_word);
     ...
     //! Get a value from a string taking into account the unit symbol.
       ...
       *   \endcode
       */
      static bool find_value_with_unit (const std::string & a_word, double & a_value, std::string & a_unit_label);
