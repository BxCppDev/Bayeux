...
============================================================================*/
#ifndef datatools_Configure_h
#define datatools_Configure_h
...
# define kwsys_ns(x) datatools##x
# define kwsysEXPORT datatools_EXPORT
#endif
...
#define datatools_NAME_IS_KWSYS 0
...
#define datatools_LFS_REQUESTED 1

/* Whether Large File Support is available.  */
#if datatools_LFS_REQUESTED
# define datatools_LFS_AVAILABLE 1
#endif
...
#  error "datatools/Configure.h must be included before sys/types.h"
# endif
  /* Enable the large file API if it is available.  */
# if datatools_LFS_AVAILABLE && \
     !defined(datatools_LFS_NO_DEFINES)
#  if !defined(_LARGEFILE_SOURCE) && \
      !defined(datatools_LFS_NO_DEFINE_LARGEFILE_SOURCE)
#   define _LARGEFILE_SOURCE
#  endif
#  if !defined(_LARGEFILE64_SOURCE) && \
      !defined(datatools_LFS_NO_DEFINE_LARGEFILE64_SOURCE)
#   define _LARGEFILE64_SOURCE
#  endif
#  if !defined(_LARGE_FILES) && \
      !defined(datatools_LFS_NO_DEFINE_LARGE_FILES)
#   define _LARGE_FILES
#  endif
#  if !defined(_FILE_OFFSET_BITS) && \
      !defined(datatools_LFS_NO_DEFINE_FILE_OFFSET_BITS)
...
#  if defined(datatools_EXPORTS)
#   define datatools_EXPORT __declspec(dllexport)
#  else
#   define datatools_EXPORT __declspec(dllimport)
#  endif
# elif __GNUC__ >= 4
#  define datatools_EXPORT __attribute__ ((visibility("default")))
# else
...
#if !defined(datatools_NO_WARNING_ENABLE)
# if defined(_MSC_VER)
...
#if !defined(datatools_NO_WARNING_DISABLE)
# if defined(_MSC_VER)
...
/* MSVC 6.0 in release mode will warn about code it produces with its
   ...
   by other compilers.  */
#if !defined(datatools_NO_WARNING_DISABLE_BOGUS)
