    ...
    namespace service {
      ...
      public:
        ...
        public:
          ...
          bool has_service_creator (const std::string & a_service_id) const;

          service_creator_type & get_service_creator (const std::string & a_service_id);
          ...
          void dump_service_creators (std::ostream & a_out = std::clog);
      ...
      public:
        ...
        // ctor :
        default_creator_registration (const std::string & a_service_id)
