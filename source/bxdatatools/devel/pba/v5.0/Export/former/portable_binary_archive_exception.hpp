#ifndef BOOST_ARCHIVE_PORTABLE_BINARY_ARCHIVE_EXCEPTION_HPP
#define BOOST_ARCHIVE_PORTABLE_BINARY_ARCHIVE_EXCEPTION_HPP
...
namespace archive {
	...
	public:
		...
		portable_binary_archive_exception(signed char invalid_size) 
		...
		template <typename T> 
		portable_binary_archive_exception(const T& abnormal) 
			: boost::archive::archive_exception(other_exception) 
...
#endif // BOOST_ARCHIVE_PORTABLE_BINARY_ARCHIVE_EXCEPTION_HPP
