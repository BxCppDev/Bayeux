 ...
 * to store/load floating numbers including non-finite and special 
 * values.
 *
 */
...
int main (void)
{
  ...
  std::string filename = "pba_2.data"; 

  {
    // A normalized single precision floating number :
    float pi = 3.14159265; 

    // Single precision zeroed floating number :
    float zero = 0.0;

    // A denormalized single precision floating number :
    float tiny = 1.e-40;
    
    // A single precision floating number with `+Infinity' value :
