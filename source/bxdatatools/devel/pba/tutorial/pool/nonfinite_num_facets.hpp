...
protected:
    ...
    {
      cerr << "nonfinite_num_get::do_get 1: " << endl;
        get_and_check_eof(it, end, iosb, state, val);
	cerr << "nonfinite_num_get::do_get 1: val = " << val << endl;
        return it;
    }
    ...
    {
      cerr << "nonfinite_num_get::do_get 2: " << endl;
        get_and_check_eof(it, end, iosb, state, val);
	cerr << "nonfinite_num_get::do_get 2: val = " << val << endl;
        return it;
    }
    ...
    {
      cerr << "nonfinite_num_get::do_get 3: " << endl;
        get_and_check_eof(it, end, iosb, state, val);
        return it;
    }
...
private:
    ...
    {
      cerr << "nonfinite_num_get::positive_nan: " << endl;
    ...
    {
      cerr << "nonfinite_num_get::get_and_check_eof: " << endl;
    ...
    template<class ValType> void get_signed(
        ...
        std::ios_base::iostate& state, ValType& val) const
    {
      cerr << "nonfinite_num_get::get_signed: " << endl;
        const std::ctype<CharType>& ct
            = std::use_facet<std::ctype<CharType> >(iosb.getloc());
    ...
    template<class ValType> void get_unsigned(
        ...
        std::ios_base::iostate& state, ValType& val) const
    {
      cerr << "nonfinite_num_get::get_unsigned: " << endl;
    ...
    template<class ValType> void get_i(
        ...
        std::ios_base::iostate& state, ValType& val) const
    {
     cerr << "nonfinite_num_get::get_i: " << endl;
    ...
    template<class ValType> void get_n(
        ...
        std::ios_base::iostate& state, ValType& val) const
    {
     cerr << "nonfinite_num_get::get_n: " << endl;
    ...
    template<class ValType> void get_q(
        ...
        std::ios_base::iostate& state, ValType& val) const
    {
     cerr << "nonfinite_num_get::get_q: " << endl;
        if(!std::numeric_limits<ValType>::has_quiet_NaN 
    ...
    template<class ValType> void get_one_hash(
        ...
        std::ios_base::iostate& state, ValType& val) const
    {
     cerr << "nonfinite_num_get::get_one_hash: " << endl;
        ++it;
    ...
    template<class ValType> void get_one_hash_i(
        ...
        std::ios_base::iostate& state, ValType& val) const
    {
     cerr << "nonfinite_num_get::get_one_hash_i: " << endl;
        ++it;
    ...
    {
      cerr << "nonfinite_num_get::peek_char: ct = '" << "'" << endl;
        if(it == end) return 0;
    ...
    {
      cerr << "nonfinite_num_get::match_string: s=='" << s << "'" << endl;
