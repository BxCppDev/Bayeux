  ...
  try {
...

    {
      ...
      if (datatools::load_ocd<foo>(OCD)) {
        ...
        std::ofstream ocd_doc("ex_OCD.foo.doc.txt");
        OCD.print(ocd_doc, "");
        OCD.dump(std::clog, "OCD for the foo class : ");
...

    {
      ...
      if (datatools::load_ocd<datatools::service_manager>(OCD)) {
        ...
        std::ofstream ocd_doc("ex_OCD.service_manager.doc.txt");
        OCD.print(ocd_doc, "");
