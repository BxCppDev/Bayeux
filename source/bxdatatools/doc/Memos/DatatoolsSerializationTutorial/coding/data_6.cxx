...
int main (void)
{
  ...
  typedef std::vector<datatools::i_serializable *> data_array_type; // Useful typedef
  ...
  // Serialize some mixed 'sdata1' and 'sdata2' instances :
  {
    ...
    for (int i = 0; i < 10; ++i) {
        datatools::i_serializable * a_data_ptr;
    ...
    std::cout << std::endl;
    datatools::data_writer the_writer ("data_6.txt", datatools::using_multi_archives);
  ...
  {
    data_array_type data;
    datatools::data_reader the_reader ("data_6.txt", datatools::using_multi_archives);
