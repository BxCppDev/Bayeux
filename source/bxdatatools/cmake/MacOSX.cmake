# - datatools configuration for Mac OS X
#
#
...
if(APPLE AND NOT NON_NATIVE_TARGET)
  if(NOT OSX_CONFIG_HAS_BEEN_RUN_BEFORE)
    ...
    if(${CMAKE_MAJOR_VERSION} EQUAL 2 
        AND ${CMAKE_MINOR_VERSION} EQUAL 4 
        AND ${CMAKE_PATCH_VERSION} LESS 7)
      message(STATUS "Warning: A critical CMake bug exists in 2.4.6 and below.  "
    ...
    if(NOT FORCE_32BIT 
        AND (EXISTS /Developer/SDKs/10.5.sdk 
          OR EXISTS /Developer/SDKs/MacOSX10.6.sdk))
      ...
      if(EXISTS /Developer/SDKs/MacOSX10.4u.sdk OR FORCE_32BIT)
        ...
        set(CMAKE_CXX_FLAGS 
          "${CMAKE_CXX_FLAGS} -mmacosx-version-min=10.4 -m32"
          CACHE STRING "Flags used by the compiler during all build types."
          FORCE)
      else()
