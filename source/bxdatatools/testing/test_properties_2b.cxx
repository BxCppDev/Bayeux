...
int main(int argc_, char ** argv_)
{
  ...
  try {
    ...
    datatools::properties my_dict6;
    my_dict.export_and_rename_starting_with(my_dict6, "visibility.",
                                            "visu.");
    my_dict6.dump(std::clog);
    ...
    std::cout << std::endl << "Exported string-based dictionary:" << std::endl;
