...
void check_compare (const datatools::version_id & v0_,
                    const datatools::version_id & v1_,
                    bool major_only_ = false)
{
  if (datatools::version_id::are_orderable (v0_, v1_, major_only_))
    {
...
void check_match (const datatools::version_id & v0_,
                  const string & rule_,
                  bool major_only_ = false)
{
  try
  ...
  try
    {
...

      {
        ...
        datatools::version_id v4 (3,1,4,"159-a");
        v4.dump (clog, "v4 : ");
        ...
        datatools::version_id v8 (3,-1,-1, "159");
        v8.dump (clog, "v8 : ");

        datatools::version_id v9 (3,1,4, "alpha");
        v9.dump (clog, "v9 : ");

        datatools::version_id v10 (3,1,4, "rc0");
        v10.dump (clog, "v10 : ");
