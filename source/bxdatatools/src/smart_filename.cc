...
namespace datatools {
  ...
  // static
  const int smart_filename::MODE_INCREMENTAL_UNRANGED;
  const int smart_filename::MODE_INCREMENTAL_DEFAULT_START;
  const int smart_filename::MODE_INCREMENTAL_DEFAULT_INCREMENT;
