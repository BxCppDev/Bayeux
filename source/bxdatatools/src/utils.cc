...
namespace datatools {
  ...
  namespace utils {
    ...
    bool fetch_path_processor::process(std::string & path_text_)
    {
      return _process_ (path_text_);
    }
    
    bool fetch_path_processor::_process_(std::string & text_)
    {
