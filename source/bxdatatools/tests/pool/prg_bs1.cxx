 ...
 *
 * If one adds in the program: 
 * BOOST_CLASS_TRACKING(data1, boost::serialization::track_never)
 * then the program work quite well but:
 * - there is duplicated data in the archive
 * - the pointer is restored in the 'data2' instance
 *   and is not deleted at destruction. 
...
/* Uncomment this line to check that it will partially work
 * with side-effects (duplicate data, memory leak).
 */
//BOOST_CLASS_TRACKING(data1, boost::serialization::track_never)
