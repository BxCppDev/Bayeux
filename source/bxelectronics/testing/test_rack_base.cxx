...
int main( int argc_, char * argv_[])
{
  ...
  try {
    ...
    rack.set_name(electronics::make_indexed_name("Rack_", 0));
    rack.set_display_name(electronics::make_indexed_name("Rack #", 0));
    rack.set_terse_description("A dummy rack");
    ...
    for (int iboard = 0; iboard < 3; iboard++) {
      ...
      board.set_max_number_of_mezzanine_boards(0);
      {
        ...
        board.add_daughter("CTRL_FPGA", ctrl_fpga_handle);
        ctrl_fpga.lock();
      }
