...
function do_geomtools_setup ()
{
    ...
    if [ $? -ne 0 ]; then
	echo "ERROR: do_geomtools_setup: Cannot find GSL setup ! Abort !" 1>&2
	return 1
    fi
    ...
    export GEOMTOOLS_BIN_DIR="@CMAKE_INSTALL_PREFIX@/bin"
    export GEOMTOOLS_ETC_DIR="@CMAKE_INSTALL_PREFIX@/etc"
    export GEOMTOOLS_LIB_DIR="@CMAKE_INSTALL_PREFIX@/lib"
	...
	if [ -n "${CMAKE_MODULE_PATH}" ]; then 
            export CMAKE_MODULE_PATH="@CMAKE_INSTALL_PREFIX@/@GEOMTOOLS_CMAKE_MODULE_INSTALL_DIR@:${CMAKE_MODULE_PATH}"
	else
            export CMAKE_MODULE_PATH="@CMAKE_INSTALL_PREFIX@/@GEOMTOOLS_CMAKE_MODULE_INSTALL_DIR@"
	fi
    fi
