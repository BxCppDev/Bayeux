 ...
 *
 */
#ifndef GEOMTOOLS_DETAIL_REFLECTION_LINK_GUARD_H_
#define GEOMTOOLS_DETAIL_REFLECTION_LINK_GUARD_H_
 ...
 *        against the geomtools_reflection DLL with new gcc 4.6 linking strategy
 *        even if no explicit geomtools reflection code is explicitely
