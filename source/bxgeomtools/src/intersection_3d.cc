...
namespace geomtools {
                                   ...
                                   double skin_) const
  {
    ...
    if (debug)
      {
        std::clog << "geomtools::intersection_3d::find_intercept: entering..." << std::endl;
      }
    ...
    if (debug)
      {
        std::clog << "geomtools::intersection_3d::find_intercept: shape1 is '" 
                  << sh3d1.get_shape_name () << "'" << std::endl;
        std::clog << "geomtools::intersection_3d::find_intercept: shape2 is '" 
    ...
    for (int ishape = 0; ishape < (int) NSHAPES; ishape++)
      {
        ...
        if (debug)
          {
            std::clog << "geomtools::intersection_3d::find_intercept: from_i=" << from_i << std::endl;
            std::clog << "geomtools::intersection_3d::find_intercept: child_dir_i=" << child_dir_i << std::endl;
          }
            ...
            if (counter > max_counter)
              {
                ...
                message << "geomtools::intersection_3d::find_intercept: "
    ...
    if (debug)
      {
        std::clog << "geomtools::intersection_3d::find_intercept: ok1=" 
                  << intercept_ok[0] << std::endl;
        std::clog << "geomtools::intersection_3d::find_intercept: ok2="
