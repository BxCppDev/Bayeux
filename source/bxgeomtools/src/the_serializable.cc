    ...
    namespace serialization {
      ...
      dynamic_link_guard::dynamic_link_guard ()
      {
        ...
        if (dynamic_link_guard::_g_devel_)
          {
            std::clog << "geomtools::detail::serialization::dynamic_link_guard::CTOR: Ok." << std::endl;
          }
        return;
      }
      ...
      dynamic_link_guard::~dynamic_link_guard ()
      {
        if (dynamic_link_guard::_g_devel_)
          {
            std::clog << "geomtools::detail::serialization::dynamic_link_guard::DTOR: Ok." << std::endl;
          }
        return;
      }
      ...
      dynamic_link_guard & dynamic_link_guard::instance ()
      {
        ...
        if (dynamic_link_guard::_g_devel_)
          {
            std::clog << "geomtools::detail::serialization::dynamic_link_guard::instance: Ok." << std::endl;
          }
