...
namespace geomtools {
                                                     ...
                                                     geomtools::models_col_type * models_)
  {
    ...
    _mother_.set_y (_y_);
    _mother_.set_z (_z_);
    DT_THROW_IF (! _mother_.is_valid (), std::logic_error, "Invalid dimension(s) for the mother box !");
    ...
    DT_THROW_IF (c > _z_, std::logic_error, "Mother box is not long enough (Z ) to host the extrusion !");
