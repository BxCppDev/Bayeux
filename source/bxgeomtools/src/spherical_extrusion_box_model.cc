...
namespace geomtools {
  ...
  const string & spherical_extrusion_box_model::get_material () const
  {
    return _material_;
  }
  ...
  void spherical_extrusion_box_model::_at_construct (const string & name_,
                                                          ...
                                                          geomtools::models_col_type * models_)
  {
    ...
    if (devel) clog << "DEVEL: spherical_extrusion_box_model::_at_construct: Entering..." << endl;
    ...
    if (config_.has_key ("material.ref"))
    ...
    else
      {
        ...
        message << "geomtools::spherical_extrusion_box_model::_at_construct: "
    ...
    if (devel) clog << "DEVEL: geomtools::spherical_extrusion_box_model::_at_construct: Properties are parsed !" << endl;
    ...
    if (_r_extrusion_ > _x_ || _r_extrusion_ > _y_)
      {
        ostringstream message;
        message << "geomtools::spherical_extrusion_box_model::_at_construct: "
                << "Extrusion radius is larger than mother box dimension !";
        throw logic_error (message.str ());
      }
    ...
    if (c > _z_)
      {
        throw logic_error ("geomtools::spherical_extrusion_box_model::_at_construct: Mother box is not long enough (Z ) to host the extrusion !");
      }
    double h = _z_ - c;
    ...
    if (devel)
      {
        cerr << "DEVEL: " << "geomtools::spherical_extrusion_box_model::_at_construct: "
             << "x=" << x / CLHEP::mm << " mm" << endl;
        cerr << "DEVEL: " << "geomtools::spherical_extrusion_box_model::_at_construct: "
             << "y=" << y / CLHEP::mm << " mm" << endl;
        cerr << "DEVEL: " << "geomtools::spherical_extrusion_box_model::_at_construct: "
    ...
    if (devel) clog << "DEVEL: geomtools::spherical_extrusion_box_model::_at_construct: zsphere=" << zsphere / CLHEP::mm << " mm" << endl;
    ...
    // Install proposed 'stackable data' pointer in the shape:
    {
      ...
      if (devel)
        {
          clog << "DEVEL: spherical_extrusion_box_model::_at_construct: Entering..." << endl;
          sd_ptr->tree_dump (cerr, "spherical_extrusion_box_model::_at_construct: Stackable data: ", "DEVEL: ");
        }
    }
    ...
    if (devel)
      {
        this->tree_dump (clog, "spherical_extrusion_box_model::_at_construct: ", "DEVEL: ");
      }
    if (devel) clog << "DEVEL: spherical_extrusion_box_model::_at_construct: Exiting." << endl;
    return;
  }

  /*** dump ***/

  void spherical_extrusion_box_model::tree_dump (ostream & out_,
                                                      const string & title_,
                                                                       ...
                                                                       void *)
  {
    ...
    if (solid == 0)
      {
        ostringstream message;
        message << "geomtools::spherical_extrusion_box_model::gnuplot_draw_user_function: "
...
// end of spherical_extrusion_box_model.cc
