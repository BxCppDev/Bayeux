...
namespace geomtools {
                       ...
                       double skin_) const
  {
    ...
    return sh3d1.is_inside (pos1, skin_) && sh3d2.is_outside (pos2, skin_);
  }
                                 ...
                                 double skin_) const
  {
    ...
    const vector_3d pos1 = p1.mother_to_child (position_);
    const vector_3d pos2 = p2.mother_to_child (position_);
    return (sh3d1.is_on_surface (pos1, ALL_SURFACES, skin_) && sh3d2.is_outside (pos2, skin_))
      || (sh3d2.is_on_surface (pos2, ALL_SURFACES, skin_)   && ! sh3d1.is_outside (pos1, skin_));
  }
