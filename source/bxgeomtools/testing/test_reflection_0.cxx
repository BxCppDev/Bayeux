...
void test_placement()
{
  ...
  DR_OBJECT plctObj0 = plctMetaClass.construct();
...
void test_base_hit()
{
  ...
  DR_OBJECT hObj0 = hitMetaClass.construct();
...
void test_geom_id()
{
  ...
  DR_OBJECT vObj0 = gidMetaClass.construct(DR_ARGS(1203, 1,3,4));
  ...
  DR_OBJECT vObj1 = gidMetaClass.construct(DR_ARGS(1220, 1,3,4));
  ...
  DR_OBJECT vObj2 = gidMetaClass.construct(DR_ARGS(1223, 9,4));
...
void test_vector_3d()
{
  ...
  DR_OBJECT vObj0 = v3dMetaClass.construct(DR_ARGS(1.0, 2.0, 3.0));
