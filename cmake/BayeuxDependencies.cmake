...
if(Bayeux_WITH_ROOT)
  ...
  if(ROOT_VERSION VERSION_LESS 6)
    ...
    if(ROOT_VERSION VERSION_LESS_EQUAL 6.16.00)
      include(${ROOT_DIR}/modules/RootNewMacros.cmake)
    endif()
  endif()
  set(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH_PREROOT})
  message(STATUS "Found ROOT at ROOT_DIR      = '${ROOT_DIR}'")
  list(APPEND BAYEUX_DEFINITIONS "-DR__HAS_STD_STRING_VIEW")
  # add_definitions("-DR__HAS_STD_STRING_VIEW")
endif()
...
if(Bayeux_WITH_GEANT4_MODULE)
  set(BAYEUX_GEANT4_MIN_VERSION "9.6.0")
  find_package(Geant4 ${BAYEUX_GEANT4_MIN_VERSION} REQUIRED ui_all vis_all gdml NO_MODULE)
  if(Geant4_DATASETS)
  ...
  if (Geant4_VERSION VERSION_GREATER_EQUAL 10)
    ...
    if (Geant4_VERSION VERSION_GREATER_EQUAL 11)
      if (${PROJECT_NAME_UC}_CXX_STANDARD VERSION_LESS 17)
	message( FATAL_ERROR "Geant4 version ${Geant4_VERSION} requires C++ >=17!")
      endif()
    endif()
    
    option(BAYEUX_WITH_GEANT4_MT "Bayeux Geant4 extension build with MT support" ON)
    set(Bayeux_GEANT4_MT 0)
    if(BAYEUX_WITH_GEANT4_MT)
      set(Bayeux_GEANT4_MT 1)
    endif()
  endif()
