...
message ( STATUS "${PROJECT_NAME}: Number of processors = ${PROCESSOR_COUNT}" )
...
elseif ( BAYEUX_HALF_PROCESSORS )
  if ( PROCESSOR_COUNT GREATER 1 )
    ...
    message ( STATUS "${PROJECT_NAME}: Using half the available processors : ${PROCESSOR_COUNT}" )
  else ( )
    set ( PROCESSOR_COUNT 1 )
  endif ( )
endif ( )
...
message( STATUS "${PROJECT_NAME}: External projects will build with ${BAYEUX_PARALLEL_JOBS} parallel jobs" )
